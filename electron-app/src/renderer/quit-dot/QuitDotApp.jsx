...
function QuitDotApp() {
  ...
  useEffect(() => {
    ipcRenderer.send('set-quit-dot-click-through', true)
  }, [])
    ...
    >
      <div style={{ position: 'relative' }}>
        <div
          ...
          onMouseEnter={() => {
            setIsHovered(true)
            ipcRenderer.send('set-quit-dot-click-through', false)
          }}
          onMouseLeave={() => {
            setIsHovered(false)
            ipcRenderer.send('set-quit-dot-click-through', true)
        ...
        <Tooltip text="Quit" hotkey="⌘Q" show={isHovered} />
      </div>
    </div>
  )
}
